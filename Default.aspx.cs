...
public partial class _Default : System.Web.UI.Page
{
    ...
    private const string ImageBucketName ="testmybasegallery";

    private string dbinstance = "palanidbinstance.csesom7yxvw9.us-west-2.rds.amazonaws.com";
    private string userid = "sa"; 
    private string password = "password"; 
    private string database = "palanidb"; 

    protected void Page_Load(object sender, EventArgs e)
    {
        InitializeVariables();
        CreateTable(); //Tobe uncommneted 
